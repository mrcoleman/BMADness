...
public class ZaiProvider : IProvider
{
    private readonly OpenAIClient _client;
    public string Model { get; set; }

    public ZaiProvider(AllSettings settings)
    {
        _client = new OpenAIClient(new ApiKeyCredential(settings.Providers.Zai.ApiKey), new OpenAIClientOptions
        {
            Endpoint = new Uri(settings.Providers.Zai.Url),
